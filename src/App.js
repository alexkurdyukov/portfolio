...
const skillData = [
  ...
  { skillName: "Typescript", skillPercent: "25%" },
    ...
    <div>
      <table className="table">
        ...
        <tr className="table__technologies">
          <th className="table__technology">HTML</th>
          <th className="table__technology">CSS</th>
          <th className="table__technology">SCSS</th>
          <th className="table__technology">JS</th>
          <th className="table__technology">React</th>
          <th className="table__technology">TS</th>
          <th className="table__technology">Redux</th>
        </tr>
      </table>
    </div>
  );
...
//             <div className="table__cell-progress"></div>
//           </td>
//           <td className="table__cell">
//             <div className="table__cell-progress"></div>
//           </td>
...
const App = () => {
  ...
  return (
    <div className="layout">
      ...
      {windowWidth && windowWidth > 1500 && <Socials />}
    </div>
  );
};
