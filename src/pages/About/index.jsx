	...
	return (
		<div className="biography">
			...
			<div className="biography-container">
				...
				<span className="biography_green">Alexey Kurdyukov</span>,  I am a frontend developer. I like to write code using Typescript, React and Redux. I like to learn something new. I always strive for personal and professional growth. Right now i'm interesting in node.js and next.js. My stack of technologies: 
        ...
        <div className='biography__letter'>Thanks for watching. I will be glad to anyfeedback</div>
			</div>
		</div>
	);
};
...
const hardSkillsData = [
	...
	{ skillName: "CSS", skillPercent: "90%" },
	{ skillName: "Figma", skillPercent: "65%" },
	{ skillName: "JS", skillPercent: "85%" },
	{ skillName: "React", skillPercent: "80%" },
	{ skillName: "TS", skillPercent: "70%" },
	{ skillName: "Redux", skillPercent: "75%" },
];
